...
#ifndef SE1_INJECTOR_INCL_TYPES_H
#define SE1_INJECTOR_INCL_TYPES_H

/* Available injector types for replacing specific libraries */
...
#endif /* SE1_INJECTOR_INCL_TYPES_H */
